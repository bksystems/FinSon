        ...
        <div class="card" style="font-size:14px;">
            <div class="card-header">Submenu</div>
                <ul class="list-group list-group-flush">
                    ...
                    <?= $this->Form->postLink(
                                    __('Eliminar'),
                                    ['action' => 'delete', $salesTypesPayment->uuid],
                                    ['confirm' => __('Are you sure you want to delete # {0}?', $salesTypesPayment->uuid), 'class' => 'list-group-item']
                                ) ?>
