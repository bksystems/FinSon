        ...
        <div class="card" style="font-size:14px;">
            <div class="card-header">Submenu</div>
                <ul class="list-group list-group-flush">
                    ...
                    <?= $this->Form->postLink(
                                    __('Eliminar'),
                                    ['action' => 'delete', $bpsBusinessPartnersRol->uuid],
                                    ['confirm' => __('Are you sure you want to delete # {0}?', $bpsBusinessPartnersRol->uuid), 'class' => 'list-group-item']
                                ) ?>
    ...
    <div class="col-md-10">
        <div class="card">
            <div class="card-header">
                <?= __('Edit Bps Business Partners Rol') ?>
            </div>
            <div class="card-body">
                ...
                <fieldset>
                    ...
                    echo $this->Form->control('bps_types_rol_uuid', [ 'class' => 'form-control form-control-sm']);
                    ?>
                </fieldset>
                <br>
