        ...
        <div class="card" style="font-size:14px;">
            <div class="card-header">Submenu</div>
                <ul class="list-group list-group-flush">
                    ...
                    <?= $this->Form->postLink(
                                    __('Eliminar'),
                                    ['action' => 'delete', $structuresMunicipality->uuid],
                                    ['confirm' => __('Are you sure you want to delete # {0}?', $structuresMunicipality->uuid), 'class' => 'list-group-item']
                                ) ?>
    ...
    <div class="col-md-10">
        <div class="card">
            <div class="card-header">
                <?= __('Edit Structures Municipality') ?>
            </div>
            <div class="card-body">
                <?= $this->Form->create($structuresMunicipality) ?>
                <fieldset>
                    <?php
                    echo $this->Form->control('structures_country_uuid', [ 'class' => 'form-control form-control-sm']);
                    echo $this->Form->control('structures_state_uuid', [ 'class' => 'form-control form-control-sm']);
