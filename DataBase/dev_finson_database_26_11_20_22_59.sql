...
--
-- Host: localhost:8889
-- Generation Time: Nov 27, 2020 at 04:48 AM
...
--
-- Table structure for table `bps_business_partners_phones`
--
...
--
-- Dumping data for table `bps_business_partners_phones`
--
...
--
-- Table structure for table `bps_business_partners_rols`
--
...
--
-- Dumping data for table `bps_business_partners_rols`
--
...
--
-- Table structure for table `bps_types_rols`
--
...
--
-- Dumping data for table `bps_types_rols`
--
...
CREATE TRIGGER `tg_sales_credits_amortization_table_event` AFTER INSERT ON `sales_credits` FOR EACH ROW BEGIN
    ...
    WHILE n_py <= t_py DO
    	...
    	INSERT INTO sales_credits_amortizations_tables values (UUID(), New.uuid, n_py, date_payment, New.payment, payment_principal, payment_ineterest, balance, adjustment, now(), now());
...
--
-- Table structure for table `sales_credits_amortizations_tables`
--
...
--
-- Table structure for table `sales_products_types_states`
--
...
--
-- Dumping data for table `sales_products_types_states`
--
...
--
-- Table structure for table `sales_types_payments`
--
...
--
-- Dumping data for table `sales_types_payments`
--
...
--
-- Indexes for table `bps_business_partners_phones`
--
ALTER TABLE `bps_business_partners_phones`
  ADD PRIMARY KEY (`uuid`);

--
-- Indexes for table `bps_business_partners_rols`
--
...
--
-- Indexes for table `bps_types_rols`
--
...
--
-- Indexes for table `sales_credits_amortizations_tables`
--
...
--
-- Indexes for table `sales_products_types_states`
--
ALTER TABLE `sales_products_types_states`
  ADD PRIMARY KEY (`uuid`);

--
-- Indexes for table `sales_types_payments`
--
