...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-11-2020 a las 01:35:14
...
INSERT INTO `sales_credits` (`uuid`, `bps_business_partner_uuid`, `sales_product_uuid`, `init_date_credit`, `end_date_credit`, `sales_products_types_state_uuid`, `requested_amount`, `amount_payable`, `payment`, `day_week_payment`, `created`, `modified`) VALUES
('24ff3fcc-f001-41ae-b250-366937f525aa', 'b0634d07-3320-4223-ab59-71f7e9527f13', 'db554dd4-1011-4ece-a19b-020d924e1a4d', '2020-11-03', '2021-02-23', '30af1e37-032b-4f4f-9c40-60a7d6827e3a', 9000, 10920, 1365, 'Martes', '2020-11-26 22:47:30', '2020-11-26 22:47:30');

--
-- Disparadores `sales_credits`
--
DELIMITER $$
CREATE TRIGGER `tg_sales_credits_amortization_table_event` AFTER INSERT ON `sales_credits` FOR EACH ROW INSERT INTO sales_credits_amortizations_tables values (uuid(), New.uuid, now(), now())
$$
DELIMITER ;
...
INSERT INTO `sales_credits_amortizations_tables` (`uuid`, `sales_credit_uuid`, `created`, `modified`) VALUES
('5dc7277d-3039-11eb-a819-18dbf2217749', '24ff3fcc-f001-41ae-b250-366937f525aa', '2020-11-26 22:47:30', '2020-11-26 22:47:30');
